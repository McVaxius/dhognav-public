...
public sealed class Plugin : IDalamudPlugin
{
    ...
    private readonly WindowSystem windows = new("DhogNav.PublicShell");
    ...
    public Plugin(IDalamudPluginInterface pluginInterface, ICommandManager commandManager, ITextureProvider textures)
    {
        ...
        commandManager.AddHandler("/dnav", new CommandInfo(OnCommand)
        {
            HelpMessage = "Open the DhogNav introduction and full-plugin installation instructions.",
        });
    ...
    public void Dispose()
    {
        ...
        pluginInterface.UiBuilder.OpenMainUi -= OpenIntroduction;
        pluginInterface.UiBuilder.OpenConfigUi -= OpenIntroduction;
        commandManager.RemoveHandler("/dnav");
